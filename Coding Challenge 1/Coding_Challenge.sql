...
DECLARE @customerID INT = 1; -- We can replace 1 with any desired customerID
...
SELECT *
FROM Customer
WHERE email = 'sarah@example.com'; -- We can replace this with the email of any specific customer

--5. Get active leases for a specific customer.

SELECT *
FROM Lease
WHERE customerID = 2 AND endDate >= GETDATE(); -- We can replace 2 with any desired customerID
...
WHERE L.customerID = 4; -- We can replace this with any desired customerID
